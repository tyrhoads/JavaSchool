...
public class TestInventory
{
    ...
    @Test
    public void testToStringContentAndLineBreaks()
    {
        List<ItemStack> stacksToAdd = Arrays.asList(
            new ItemStack(testItems[0]),
            new ItemStack(testItems[1]),
    ...
    @Test
    public void testToStringExactMatch()
    {
        List<ItemStack> stacksToAdd = Arrays.asList(
            new ItemStack(testItems[0]),
            new ItemStack(testItems[1]),
        ...
        String expectedOutput = String.join(
            ...
            " -Used 3 of 4 slots",
            String.format("  %s", stacksToAdd.get(0)),
            String.format("  %s", stacksToAdd.get(1)),
            String.format("  %s", stacksToAdd.get(2)),
            ""
        );

        String aBagAsStr = aBag.toString();
        assertThat(aBagAsStr, is(equalTo(expectedOutput)));
    }
}
